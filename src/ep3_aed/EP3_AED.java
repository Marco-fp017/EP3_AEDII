...
import entities.IDs;
import services.DistrGrausComponentes;

public class EP3_AED {
    
    public static void main(String[] args) {
        List<IDs> IDList = new ArrayList<>(); //lista de IDs
        List<List<IDs>> componentes = new ArrayList<>();    //lista de componentes conexas
        List<DistrGrausComponentes> tamComponentes = new ArrayList<>(); //lista da quantidade de componentes com determinado grau
        ...
        try (BufferedReader bf = new BufferedReader (new FileReader(sc.nextLine()))){
            ...
            List<IDs> auxCompo = new ArrayList<>();
